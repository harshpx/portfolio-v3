...
<Motion
	...
	let:motion
>
	<div use:motion id="homepage" class="flex h-full w-full flex-col gap-2 overflow-x-hidden overflow-y-auto px-2 pb-2">
		...
		<div id="contact" class="flex min-h-full w-full shrink-0 flex-col items-center justify-center border border-white">
			<Contact />
			<Footer />
		</div>
	</div>
