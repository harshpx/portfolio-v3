	...
	projects: [
		{
			...
			description: [
				...
				"Implemented secure **JWT-based authentication** using **Spring Security**, with **OAuth2** for Google login.",
				...
				"Used **Zustand** for **global state management**, reducing re-renders and ensuring consistent state across the app.",
		...
		},
		{
			...
			description: [
				...
				"Built a **Kubernetes Job** based code execution service using **KubernetesClient** java API, that spins up and deletes temporary pods.",
				"Leveraged Resend for mailing service & **SMTP** and used **Redis** to store OTPs temporarily for email verification.",
				"Deployed **1 Kubernetes cluster** node with 2 deployment instances.",
				"Used **Traefik - Ingress** for api gateway routing and load balancing. Automated CI/CD using **github actions**.",
			],
			links: {
